...
function AboutMe({}: Props) {
  return (
    <div
      id="About"
      className="relative px-4 md:px-8 lg:px-40 bg-aboutme-background bg-cover flex flex-col md:flex-row md:items-center justify-between w-full min-h-screen md:min-h-[70vh] lg:min-h-screen bg-white"
    >
      ...
      <div className="md:w-7/12 mb-10 lg:mb-32">
